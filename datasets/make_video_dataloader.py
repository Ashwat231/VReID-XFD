...
# <<< CHANGED: added CrossViewIdentitySampler import
...
from torchvision.transforms import ColorJitter  # ADDED----------------------------------
...
def make_dataloader(cfg):
    ...
    spatial_transform_train_stage2 = ST.Compose([
        ...
        ColorJitter(brightness=0.1, contrast=0.1, saturation=0.1, hue=0.05),  # ADDED--------------------------------
