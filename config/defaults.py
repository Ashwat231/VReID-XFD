...
# PBP Parameter
_C.MODEL.PBP_COE = 3.0
_C.MODEL.PBP_CAMERA = False
_C.MODEL.PBP_VIEW = False
# PBP metadata flags and bin counts (for altitude/distance/angle prompts)
_C.MODEL.PBP_META = True
_C.MODEL.PBP_ALT = True
_C.MODEL.PBP_DIST = True
_C.MODEL.PBP_ANGLE = True
_C.MODEL.PBP_ALT_BINS = 6
_C.MODEL.PBP_DIST_BINS = 6
_C.MODEL.PBP_ANGLE_BINS = 4

# ViFi
_C.MODEL.VIFI_WEIGHT = ''
_C.MODEL.USE_VIFI_WEIGHT = False
_C.MODEL.PROMPT_LEN = 8

# prompt
_C.MODEL.USE_LEARNABLE_PROMPT = True
...
# Dataset subset selection (for datasets with multiple test scenarios)
_C.DATASETS.SUBSET = 'case1_aerial_to_ground'
